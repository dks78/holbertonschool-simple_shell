...
void prompt(int fd, struct stat buf); /*OK*/
...
/* utility functions */
void _puts(char *str);/*OK*/
int _strlen(char *s); /*OK*/
int _strcmp(char *name, char *variable, unsigned int length);/*OK*/
int _strncmp(char *name, char *variable, unsigned int length);/*OK*/
char *_strcpy(char *dest, char *src);/*OK*/
