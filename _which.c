...
/*ici c'est ce qui permet de trouve les commandes ls cd ect en les recharchant dans les répertoires listés*/
char *_which(char *command, char *fullpath, char *path)
{
	...
	_strcpy(path_copy, path);/*copier path dans path copy */
